        ...
        static void Main(string[] args)
        {
         ...
         // score = "0"; // will still fail to compile because the "0" is still  assigned as a string -enclosed in the double quotes
            ...
            /* variables are case-sensitive */
               // the variables below are different despite having similar names string exampleVariable;
            ...
            /* increment and decrement operators */
               ...
               incrementDecrementOperators++; // The equivalent of incrementDecrementOperators += 1; or incrementDecrementOperators = incrementDecrementOperators + 1 incrementDecrementOperators--; // The equivalent of   incrementDecrementOperators -= 1; or incrementDecrementOperators = incrementDecrementOperators - 1;
